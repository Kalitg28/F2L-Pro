...
# For Any Kind Of Error Ask Us In Support Group @AV_SUPPORT_GROUP
        ...
        if len(str(user_id)) == 10:
            ...
            try:
                await client.send_message(user_id , f"<b>ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ʙʏ [ᴀᴠ ᴄʜᴀᴛ ᴏᴡɴᴇʀ](https://telegram.me/Indian_MV_Admin_Bot)\nʀᴇᴀsᴏɴ : {reason}</b>")
        ...
        if len(str(user_id)) == 10:
            try:
                unban_text = "<b>ʜᴜʀʀᴀʏ..ʏᴏᴜ ᴀʀᴇ ᴜɴʙᴀɴɴᴇᴅ ʙʏ [ᴀᴠ ᴄʜᴀᴛ ᴏᴡɴᴇʀ](https://telegram.me/Indian_MV_Admin_Bot)</b>"
